    ...
    try:
        for lang in languages:
            for query in search_queries:
                ...
                # Generator search daha esnektir ve thumbnail döner
                url = f"https://{lang}.wikipedia.org/w/api.php?action=query&generator=search&gsrsearch={encoded_query}&gsrlimit=1&prop=pageimages&format=json&pithumbsize=1080&origin=*"
